...
class Grid {
    ...
    _addRow (dataRow, rowNum, startPos = 0) {
        for (let col = 0; col < dataRow.length; col++) {
            const actualCol = col + startPos;
            this.grid[rowNum][actualCol] = dataRow[col];
...
export { processFile, getFirstLine, getAllLines, getBatches, Grid }